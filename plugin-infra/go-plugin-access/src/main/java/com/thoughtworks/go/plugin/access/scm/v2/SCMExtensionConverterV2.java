...
public class SCMExtensionConverterV2 {
    private static final Gson GSON = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
    private static final String DATE_PATTERN = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";

    private final JSONResultMessageHandler jsonResultMessageHandler;
    private final CapabilitiesConverterV2 capabilitiesConverterV2;

    public SCMExtensionConverterV2() {
    ...
    public SCMPropertyConfiguration responseMessageForSCMConfiguration(String responseBody) {
        try {
            ...
            return getScmPropertyConfiguration(configurations);
        } catch (Exception e) {
    ...
    public Capabilities responseMessageForGetCapabilities(String responseBody) {
    ...
    public String requestMessageForShouldUpdate(String provider, String eventType, String eventPayload, List<SCMMaterial> materialsConfigured) {
        ...
        map.put("event_payload", eventPayload);
    ...
    public List<SCMMaterial> responseMessageForShouldUpdate(String responseBody) {
        try {
            ...
            try {
                ...
                throw new RuntimeException("The result of shouldUpdate should be returned as a list of map of scm configurations");
            }
    ...
    private SCMPropertyConfiguration getScmPropertyConfiguration(Map<String, Map> configurations) {
        SCMPropertyConfiguration scmConfiguration = new SCMPropertyConfiguration();
