...
class SCMExtensionConverterV1Test {
    private static final String DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";

    private SCMExtensionConverterV1 scmExtensionConverterV1;
    private SCMPropertyConfiguration scmPropertyConfiguration;
    private Map<String, String> materialData;

    @BeforeEach
    void setUp() throws Exception {
        scmExtensionConverterV1 = new SCMExtensionConverterV1();
    ...
    void shouldBuildSCMConfigurationFromResponseBody() throws Exception {
        String responseBody = "{" +
                ...
                "}";
        SCMPropertyConfiguration scmConfiguration = scmExtensionConverterV1.responseMessageForSCMConfiguration(responseBody);
    ...
    void shouldBuildSCMViewFromResponse() {
        ...
        SCMView view = scmExtensionConverterV1.responseMessageForSCMView(jsonResponse);
    ...
    void shouldBuildRequestBodyForCheckSCMConfigurationValidRequest() throws Exception {
        String requestMessage = scmExtensionConverterV1.requestMessageForIsSCMConfigurationValid(scmPropertyConfiguration);
    ...
    void shouldBuildValidationResultFromCheckSCMConfigurationValidResponse() throws Exception {
        ...
        ValidationResult validationResult = scmExtensionConverterV1.responseMessageForIsSCMConfigurationValid(responseBody);
    ...
    void shouldBuildSuccessValidationResultFromCheckSCMConfigurationValidResponse() throws Exception {
        assertThat(scmExtensionConverterV1.responseMessageForIsSCMConfigurationValid("").isSuccessful()).isTrue();
        assertThat(scmExtensionConverterV1.responseMessageForIsSCMConfigurationValid(null).isSuccessful()).isTrue();
    }

    @Test
    void shouldBuildRequestBodyForCheckSCMConnectionRequest() throws Exception {
        String requestMessage = scmExtensionConverterV1.requestMessageForCheckConnectionToSCM(scmPropertyConfiguration);
    ...
    void shouldBuildSuccessResultFromCheckSCMConnectionResponse() throws Exception {
        ...
        Result result = scmExtensionConverterV1.responseMessageForCheckConnectionToSCM(responseBody);
    ...
    void shouldHandleNullMessagesForCheckSCMConnectionResponse() throws Exception {
        assertSuccessResult(scmExtensionConverterV1.responseMessageForCheckConnectionToSCM("{\"status\":\"success\"}"), new ArrayList<>());
        assertFailureResult(scmExtensionConverterV1.responseMessageForCheckConnectionToSCM("{\"status\":\"failure\"}"), new ArrayList<>());
    }

    @Test
    void shouldBuildRequestBodyForLatestRevisionRequest() throws Exception {
        String requestBody = scmExtensionConverterV1.requestMessageForLatestRevision(scmPropertyConfiguration, materialData, "flyweight");
    ...
    void shouldBuildSCMRevisionFromLatestRevisionResponse() throws Exception {
        ...
        MaterialPollResult pollResult = scmExtensionConverterV1.responseMessageForLatestRevision(responseBody);
    ...
    void shouldBuildSCMDataFromLatestRevisionResponse() throws Exception {
        ...
        MaterialPollResult pollResult = scmExtensionConverterV1.responseMessageForLatestRevision(responseBodyWithSCMData);
    ...
    void shouldBuildRequestBodyForLatestRevisionsSinceRequest() throws Exception {
        ...
        String requestBody = scmExtensionConverterV1.requestMessageForLatestRevisionsSince(scmPropertyConfiguration, materialData, "flyweight", previouslyKnownRevision);
    ...
    void shouldBuildSCMRevisionsFromLatestRevisionsSinceResponse() throws Exception {
        ...
        MaterialPollResult pollResult = scmExtensionConverterV1.responseMessageForLatestRevisionsSince(responseBody);
    ...
    void shouldBuildSCMDataFromLatestRevisionsSinceResponse() throws Exception {
        ...
        MaterialPollResult pollResult = scmExtensionConverterV1.responseMessageForLatestRevisionsSince(responseBodyWithSCMData);
    ...
    void shouldBuildNullSCMRevisionFromLatestRevisionsSinceWhenEmptyResponse() throws Exception {
        MaterialPollResult pollResult = scmExtensionConverterV1.responseMessageForLatestRevisionsSince("");
        assertThat(pollResult.getRevisions()).isNull();
        assertThat(pollResult.getMaterialData()).isNull();
        pollResult = scmExtensionConverterV1.responseMessageForLatestRevisionsSince(null);
        assertThat(pollResult.getRevisions()).isNull();
        assertThat(pollResult.getMaterialData()).isNull();
    }
    ...
    void shouldBuildRequestBodyForCheckoutRequest() throws Exception {
        ...
        String requestBody = scmExtensionConverterV1.requestMessageForCheckout(scmPropertyConfiguration, "destination", revision);
    ...
    void shouldBuildResultFromCheckoutResponse() throws Exception {
        String responseBody = "{\"status\":\"failure\",messages=[\"message-one\",\"message-two\"]}";
        Result result = scmExtensionConverterV1.responseMessageForCheckout(responseBody);
    ...
    private String errorMessageForSCMConfiguration(String message) {
        try {
            scmExtensionConverterV1.responseMessageForSCMConfiguration(message);
    ...
    private String errorMessageForSCMView(String message) {
        try {
            scmExtensionConverterV1.responseMessageForSCMView(message);
            fail("should have thrown exception");
        } catch (Exception e) {
            return e.getMessage();
        }
    ...
    private String errorMessageForSCMRevisions(String message) {
        try {
            ...
            scmExtensionConverterV1.toSCMRevisions(revisionsMap);
            fail("should have thrown exception");
        } catch (Exception e) {
            return e.getMessage();
        }
    ...
    private String errorMessageForSCMRevision(String message) {
        try {
            ...
            scmExtensionConverterV1.toSCMRevision(revisionMap);
            fail("should have thrown exception");
        } catch (Exception e) {
            return e.getMessage();
        }
    ...
    private String errorMessageForEachRevision(String message) {
        try {
            Map revisionMap = (Map) new GsonBuilder().create().fromJson(message, Object.class);
            scmExtensionConverterV1.getScmRevisionFromMap(revisionMap);
            fail("should have thrown exception");
        } catch (Exception e) {
            return e.getMessage();
        }
    ...
    private String errorMessageForSCMData(String message) {
        try {
            ...
            scmExtensionConverterV1.toMaterialDataMap(dataMap);
            fail("should have thrown exception");
        } catch (Exception e) {
            return e.getMessage();
        }
